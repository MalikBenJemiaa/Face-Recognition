...
def sand_request_enter(w):
    print(w)
    res = requests.get('http://localhost:3000/accessToRoom/' + str(w) + '/LM2oVjB0aWFIC0FYwSnA')
    a = res.text
    print(a)
    if res.status_code == 200:
        print("you can enter to bodybuilding room")
    else:
        print("you can't enter to bodybuilding room")
...
# i done the process of the enter of client with her face
